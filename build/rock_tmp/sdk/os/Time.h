...
#endif
#if defined(__WIN32__) || defined(__WIN64__)
struct _os_Time__LocaleIdClass {
    struct _lang_types__ClassClass __super__;
};
...
#define GetTimeFormat(, , , , , ) os_Time__GetTimeFormat((), (), (), (), (), ())
...
#define _asctime() os_Time___asctime(())
#define asctime(timePtr) (void*) os_Time__asctime((timePtr))
...
#define LocaleId os_Time__LocaleId
#define LocaleId_class() os_Time__LocaleId_class()
#define LocaleIdClass os_Time__LocaleIdClass
#define LocaleIdClass_class() os_Time__LocaleIdClass_class()
#define LocaleId___load__() os_Time__LocaleId___load__()
...
#define Time_dateTime() (void*) os_Time__Time_dateTime()
