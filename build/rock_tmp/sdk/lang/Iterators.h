...
struct _lang_Iterators__IterableClass {
    ...
    void (*eachUntil)(lang_Iterators__Iterable*, lang_types__Closure);
...
#define Iterable_reduce(_this_, __genericReturn22, f) lang_Iterators__Iterable_reduce((void*) (_this_), (__genericReturn22), (f))
#define Iterable_each(_this_, f) lang_Iterators__Iterable_each((void*) (_this_), (f))
#define Iterable_eachUntil(_this_, f) lang_Iterators__Iterable_eachUntil((void*) (_this_), (f))
...
#define Iterator_next(_this_, __genericReturn28) lang_Iterators__Iterator_next((void*) (_this_), (__genericReturn28))
...
#define BackIterator_prev(_this_, __genericReturn29) lang_Iterators__BackIterator_prev((void*) (_this_), (__genericReturn29))
...
#define ReverseIterator_new() (void*) lang_Iterators__ReverseIterator_new()
...
#define ReverseIterator_next(_this_, __genericReturn30) lang_Iterators__ReverseIterator_next((void*) (_this_), (__genericReturn30))
#define ReverseIterator_hasPrev__quest(_this_) lang_Iterators__ReverseIterator_hasPrev__quest((void*) (_this_))
#define ReverseIterator_prev(_this_, __genericReturn31) lang_Iterators__ReverseIterator_prev((void*) (_this_), (__genericReturn31))
