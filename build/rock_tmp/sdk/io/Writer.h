...
struct _io_Writer__WriterClass {
    ...
    void (*write_chr)(io_Writer__Writer*, lang_Character__Char);
    lang_Numbers__SizeT (*write)(io_Writer__Writer*, lang_Character__Char*, lang_Numbers__SizeT);
    lang_Numbers__SizeT (*write_implicitLength)(io_Writer__Writer*, lang_String__String*);
    lang_Numbers__SizeT (*write_bufImplicitLength)(io_Writer__Writer*, lang_Buffer__Buffer*);
    lang_Numbers__SizeT (*write_strGivenLength)(io_Writer__Writer*, lang_String__String*, lang_Numbers__SizeT);
...
#define Writer_write(_this_, bytes, length) io_Writer__Writer_write((void*) (_this_), (bytes), (length))
#define Writer_write_implicitLength(_this_, str) io_Writer__Writer_write_implicitLength((void*) (_this_), (void*) (str))
#define Writer_write_bufImplicitLength(_this_, buffer) io_Writer__Writer_write_bufImplicitLength((void*) (_this_), (void*) (buffer))
#define Writer_write_strGivenLength(_this_, str, length) io_Writer__Writer_write_strGivenLength((void*) (_this_), (void*) (str), (length))
#define Writer_writef(_this_, fmt, ...) io_Writer__Writer_writef((void*) (_this_), (void*) (fmt), __VA_ARGS__)
